...
public class DimenUtils {
    ...
    public static float pxToSp(float pxValue) {
        return pxValue / MyApplication.getContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static float spToPx(float spValue) {
        return spValue * MyApplication.getContext().getResources().getDisplayMetrics().scaledDensity;
    }
}
