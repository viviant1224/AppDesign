package com.viviant.earngold.wxapi.task;
...
import com.viviant.earngold.wxapi.Constant;
import com.viviant.earngold.wxapi.bean.GetPrepayIdResult;
import com.viviant.earngold.wxapi.bean.LocalRetCode;
import com.viviant.earngold.wxapi.util.MD5;
import com.viviant.earngold.wxapi.util.WechatUtil;
...
public class GetPrepayIdTask extends AsyncTask<String, Void, GetPrepayIdResult> {
	...
	private void payWithWechat(GetPrepayIdResult result) {
		...
		mWeixinApi = WXAPIFactory.createWXAPI(context, Constant.APP_ID);
