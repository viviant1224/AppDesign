...
import com.viviant.earngold.mvp.tactical.presenter.TacticalPresenter;
...
public class TacticalFragment extends BaseFragment<TacticalPresenter> implements TacticalContract.View, SwipeRefreshLayout.OnRefreshListener{
    ...
    @Override
    protected TacticalPresenter onCreatePresenter() {
        return new TacticalPresenter(this);
    }
